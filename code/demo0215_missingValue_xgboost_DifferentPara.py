...
if __name__=='__main__':
	...
	print 'x y',train.values.shape,target.values.shape
	...
	for boost_round in [200,500]:
		
		 
		for maxDepth in [32,64]:#7  14
			...
			print('Train err is:', eval_wrapper(train_preds, target.values))# 32 100  err0.10
