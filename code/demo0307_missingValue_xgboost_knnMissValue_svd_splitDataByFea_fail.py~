...
if __name__=='__main__':
	...
	ind10,ind11,ind20,ind21,ind30,ind31=load_pickle(dataPath+'splitDataByFea')
	...
	v22_int,v22_01dim26=load_pickle(dataPath+'v22_newFea')
	...
	for col in range(xd.shape[1]):
		print  discreteInd[col],np.unique(xd[:,col]).shape
	...
	#train=np.concatenate((xdd,xc,train[:,21].reshape((-1,1)),splitFea,v22_int.reshape((-1,1)),v22_01dim26),axis=1);print 'tt dim',train.shape#0.5708 0.5725
	train=np.concatenate((xdd,xc,v22_int.reshape((-1,1)),v22_01dim26),axis=1)
	...
	train=train[ind21,:]#v24_0 no-good  v47_0good,v47_1notgood
	target=target[ind21]
